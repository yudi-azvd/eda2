...
#define PRESIDENT_INITIAL_CAPACITY 17389
#define SENATOR_INITIAL_CAPACITY 17389
#define DEPFED_INITIAL_CAPACITY 17389
#define DEPEST_INITIAL_CAPACITY 17389
#define CANDIDATES_CAPACITY 17389
