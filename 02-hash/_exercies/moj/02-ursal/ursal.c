...
#define PRESIDENT_INITIAL_CAPACITY 19423
#define SENATOR_INITIAL_CAPACITY 19423
#define DEPFED_INITIAL_CAPACITY 19423
#define DEPEST_INITIAL_CAPACITY 19423
#define CANDIDATES_CAPACITY 19423
