...
#define PRESIDENT_INITIAL_CAPACITY 20357
#define SENATOR_INITIAL_CAPACITY 20357
#define DEPFED_INITIAL_CAPACITY 20357
#define DEPEST_INITIAL_CAPACITY 20357
#define CANDIDATES_CAPACITY 20357
